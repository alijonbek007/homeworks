...
import 'package:homework/homework20/Page3.dart';
import 'package:homework/homework20/hotel_list.dart';
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        height: 30.0,
                        child: Image.asset(
                          "assets/images/homework20/filterIcon.png",
                        ),
                      ),
                    )
                  ],
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage(
                      "assets/images/homework20/hotel${i}.jpg",
                    ),
                    fit: BoxFit.cover),
  ...
  Widget rowScroll2(BuildContext context, int i) {
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
            image: AssetImage(
              "assets/images/homework20/Luxury${i + 1}.jpg",
            ),
            fit: BoxFit.cover),
        color: Colors.blue,
